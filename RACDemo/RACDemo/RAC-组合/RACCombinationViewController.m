//
//  RACCombinationViewController.m
//  RACDemo
//
...
/// 把多个信号聚合成你想要的信号，使用场景----：
/// 比如-当多个输入框都有值的时候按钮才可点击。

#import "RACCombinationViewController.h"
#import <ReactiveObjC/ReactiveObjC.h>

@interface RACCombinationViewController ()
...
@implementation RACCombinationViewController
...
- (void)combineLatest {
    RACSignal *combinSignal = [RACSignal combineLatest:@[self.accountField.rac_textSignal, self.pwdField.rac_textSignal]
